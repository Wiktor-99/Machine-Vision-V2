...
void Manipulator::createManipulator()
{
    ...
    renderFile = QUrl(QString("file:/home/rpi/Desktop/SCARA/Scara/modele/Podstawa_inz.obj"));
    Base->loader()->setSource(renderFile);
    Base->material()->setDiffuse(QColor(QRgb(0xB23149)));
    renderFile = QUrl(QString("file:/home/rpi/Desktop/SCARA/Scara/modele/Pierwsze_ramie_inz2.obj"));
    Link1->loader()->setSource(renderFile);
    renderFile = QUrl(QString("file:/home/rpi/Desktop/SCARA/Scara/modele/Drugie_ramie_inz2.obj"));
    Link2->loader()->setSource(renderFile);
    renderFile = QUrl(QString("file:/home/rpi/Desktop/SCARA/Scara/modele/trzecie_ramie1.obj"));
